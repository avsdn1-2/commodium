<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" style="width:700px;margin:0 auto" action="{{ route('pokaz.listAllProc') }}">
                @csrf
                ...
                <div class="md-form" style="width:100px;margin:0 0 0 0;float:left">
                    <select id="volume" name="volume" class="browser-default custom-select custom-select mb-3">
                        <option value="my" selected>Мои</option>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th scope="col" style="width:100px;text-align:center">Потребление тепла по общему счетчику за месяц</th>
