<x-app-layout>
    ...
    <div class="">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div style="font-size:16px;font-weight:bold">История показаний @if ($units === 'raw') <span style="font-size:13px;font-style:italic">(показания тепла в исходных единицах, которые предоставила квартира)</span> @endif</div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th scope="col" style="width:100px;text-align:center">Единицы измерения тепла</th>
                        </tr>
                        </thead>
                        ...
                        @foreach($pokazs as $pokaz)
                            <tr>
                                ...
                                <td style="text-align:center">{{ number_format($pokaz->warm,3,'.',' ') }}</td>
                                <td style="text-align:center">{{ $pokaz_units[$pokaz->flat] }}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
