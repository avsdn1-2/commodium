...
<x-app-layout>
    ...
    <div style="width:550px;margin:0 auto">
        <table class="table table-striped">
            ...
            <tbody>
            <tr>
                <td>Обслуговування дому (тариф {{ $payment['tarif_service'] }} грн за кв.м)</td>
    ...
    <div class="text-center pdf-btn">
        <a href="{{ route('pdf.generateManager',['flat' => $payment['flat'],'month' => $payment['month_m']]) }}" class="btn btn-primary">Надіслати на ємейл</a>
    </div>
</x-app-layout>
